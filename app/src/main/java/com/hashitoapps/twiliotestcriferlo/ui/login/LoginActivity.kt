...
import com.hashitoapps.twiliotestcriferlo.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FirebaseMessaging.getInstance().token.addOnCompleteListener(OnCompleteListener { task ->
            ...
            val tokenGCM = task.result
            getSharedPreferences("_", MODE_PRIVATE).edit().putString("token", tokenGCM).apply();
            Log.d("jenny",tokenGCM!!)
        })
